...
#save each resample
roi_size_df.to_csv(f'{results_dir}/roi_size_resamples.csv', index=False)
mean_act_df.to_csv(f'{results_dir}/mean_act_resamples.csv', index=False)
cortex_vol_df.to_csv(f'{results_dir}/cortex_vol_resamples.csv', index=False)
sum_selec_df.to_csv(f'{results_dir}/sum_selec_resamples.csv', index=False)
